...
(function ($) {
    ...
    var SwaggerBootstrapUi = function (options) {
        //swagger请求api地址
        this.url = "swagger/swagger_resources";
        //文档id
        this.docId = "content";
                    ...
                    $.each(newTagArrs, function (i, tag) {
                        ...
                        if (len == 0) {
                            ...
                            if (that.settings.showTagStatus) {
                                ...
                                li = $('<li class="detailMenu"><a href="javascript:void(0)"><i class="icon-text-width iconfont icon-APIwendang"></i><span class="menu-text"> ' + tag.description + "(" + tag.name + ') </span></a></li>');
                            }
                           ...
                           $.each(tag.childrens,function (i, children) {
                            ...
                            if (that.settings.showTagStatus) {
                                ...
                                titleA = $('<a href="#" class="dropdown-toggle"><i class="icon-file-alt icon-text-width iconfont icon-APIwendang"></i><span class="menu-text"> ' + tag.description + "(" + tag.name + ') <span class="badge badge-primary ">' + len + '</span></span>' + tagNewApiIcon + '<b class="arrow icon-angle-down"></b></a>');
                            }
                            //var titleA=$('<a href="#" class="dropdown-toggle"><i class="icon-file-alt icon-text-width iconfont icon-APIwendang"></i><span class="menu-text"> '+tag.name+'<span class="badge badge-primary ">'+len+'</span></span><b class="arrow icon-angle-down"></b></a>');
                            li.append(titleA);
                            //循环树
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(groupData, function (i, group) {
                    ...
                    var extBasePath = "";
                    var idx = newUrl.indexOf("/swagger/api");
                    if (idx > 0) {
                        //增强地址存在basePath
